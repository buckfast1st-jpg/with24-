...
import { Menu, X, Heart, Users, Leaf, Calendar, Utensils, ArrowRight, Phone, Mail, MapPin, Printer, Settings, LogOut, Megaphone, Loader2 } from 'lucide-react';
...
function AppContent() {
  ...
  // Site Data State (loads from backend or defaultConfig)
  const [siteData, setSiteData] = useState(defaultConfig);
  ...
  // isLoading check removed for debugging
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans text-gray-900 selection:bg-green-200">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex items-center space-x-8">
              {isHomePage ? (
                ...
                <>
                  <Link to="/" className="text-sm font-medium text-gray-700 hover:text-green-600 transition-colors">홈으로</Link>
                </>
              )}
              <Link to="/notices" className="text-sm font-medium text-gray-700 hover:text-green-600 transition-colors">공지사항</Link>
              <a href={isHomePage ? "#participate" : "/#participate"} onClick={() => setActiveFormTab('volunteer')} className="text-sm font-medium text-gray-700 hover:text-green-600 transition-colors">자원봉사</a>
              <a href={isHomePage ? "#participate" : "/#participate"} onClick={() => setActiveFormTab('donate')} className="text-sm font-medium text-gray-700 hover:text-green-600 transition-colors">후원안내</a>
              <a href={isHomePage ? "#participate" : "/#participate"} onClick={() => setActiveFormTab('donate')} className="bg-green-600 text-white px-5 py-2.5 rounded-full text-sm font-semibold hover:bg-green-700 transition-all shadow-sm hover:shadow-md inline-block text-center">
                후원하기
              </a>
        ...
        <div className="fixed inset-0 z-40 bg-white pt-20 px-4 md:hidden">
          <div className="flex flex-col space-y-4">
            {isHomePage ? (
              ...
              <Link to="/" onClick={() => setMobileMenuOpen(false)} className="text-lg font-medium p-4 border-b">홈으로</Link>
            )}
            <Link to="/notices" onClick={() => setMobileMenuOpen(false)} className="text-lg font-medium p-4 border-b">공지사항</Link>
            <a href={isHomePage ? "#participate" : "/#participate"} onClick={() => { setMobileMenuOpen(false); setActiveFormTab('volunteer'); }} className="text-lg font-medium p-4 border-b">자원봉사</a>
            <a href={isHomePage ? "#participate" : "/#participate"} onClick={() => { setMobileMenuOpen(false); setActiveFormTab('donate'); }} className="text-lg font-medium p-4 border-b">후원안내</a>
            <a href={isHomePage ? "#participate" : "/#participate"} onClick={() => { setMobileMenuOpen(false); setActiveFormTab('donate'); }} className="bg-green-600 text-white p-4 rounded-xl text-lg font-semibold mt-4 text-center block">
              후원하기
            </a>
      ...
      <Routes>
        ...
        <Route path="/notices" element={<NoticePage notices={siteData.notices} />} />
      </Routes>
